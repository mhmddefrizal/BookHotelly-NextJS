        ...
        <ul>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900">#{reservasi.id}</div>
            </div>
          </li>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900">{formatDate(reservasi.createdAt.toISOString())}</div>
            </div>
          </li>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900">{reservasi.User.name}</div>
            </div>
          </li>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900">{reservasi.User.email}</div>
            </div>
          </li>
        </ul>
        <ul>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900">{reservasi.User.phone}</div>
            </div>
          </li>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900 capitalize">{reservasi.Payment?.method ? reservasi.Payment.method.replace("_", " ") : null}</div>
            </div>
          </li>
          <li className="py-2">
            <div className="flex items-center">
              ...
              <div className="inline-flex items-center text-base font-semibold text-gray-900">{reservasi.Payment?.status}</div>
            </div>
          </li>
        </ul>
      </div>
          ...
          <tfoot>
            <tr>
              ...
              <td className="px-6 py-3 font-bold" text-right colSpan={3}>
                {reservasi.Payment && formatCurrency(reservasi.Payment.amount)}
              </td>
            </tr>
          </tfoot>
        </table>
